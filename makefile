...
#SRC = $(TARGET).c uart.c lcd_AC128.c
#SRC = $(TARGET).c uart.c lcd_AVRCTRL.c scs_pcf8583.c
SRC = $(TARGET).c uart.c lcd_AC128.c scs_pcf8583.c scs_pcf8574.c scs_m8slave.c twimaster.c
#SRC = $(TARGET).c uart.c lcd_AC128.c scs_pcf8583.c scs_pcf8574.c scs_m8slave.c
